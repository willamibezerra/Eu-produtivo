...
class _RegisterAccountPageState extends State<RegisterAccountPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: BackgroundRegisterAccount(
          size: size,
          child: Observer(
                  ...
                  Observer(
                    builder: (_) {
                      return RoundedButton(
                          ...
                          press: () {
                            widget.controller.createAccount(email: _emailController.text, password: _passWordController.text);
                              ...
                              if (widget.controller.createAccountSucess!) {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    ...
                                    content: Text(widget.controller.failureCreateUser ?? ''),
                                  ),
                                );
                              } else {
                                ScaffoldMessenger.of(context).showSnackBar(
